...
These standards are quite thorough and contain mandates for the inclusion of the vast majority of components necessary for complete reproducibility.
...
In the biomedical sciences, a group of editors reproesenting over 30 major journals  met in 2014 to address reproducibility in their field, coming to a consensus on a set of principles they wanted to uphold. Listed below are those relating specifically to the use of data and statistical methods:
...
Even though these principles seem well-developed on the surface, they fail to meet even the basic requirements defined by @Goodman341ps12 previously. Several of the principles are purely recommendations; there is no *requirement* that code be shared, nor metadata, and software requirements are quite loose, requiring no information about dependencies or software version.
...
The inclusion of code and data are only recommended and no definition of what "other materials" may mean is provided. No components of reproducibility extending beyond those required at a minimum are even considered.
...
SOURCE: https://www.aeaweb.org/journals/policies/data-code 
...
* Being unsure about licensing/data copyright
* Not knowing which data repository to use
* A lack of time
* Not being able to cover the costs of data sharing
...
* Time-intensive: With AJPS example, adds a median time of 53 days to the publication workflow, involving one or more rounds of feedback and resubmissions of the replication materials.

* Labor intensive: On average, takes 8 person-hours per manuscript to replicate the analyses and curate the materials for public release. The financial cost of this is not trivial.

https://www.insidehighered.com/blogs/rethinking-research/should-journals-be-responsible-reproducibility

Most journals have been reluctant to give additional tasks to peer reviewers who may already be overburdened with the continually increasing volume of submissions.

https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0166387

As a result, policies often encourage reviewers to consider authors' compliance with data sharing policies, but formal peer review of data only occurs in a small number of journals.

https://link.springer.com/chapter/10.1007/164_2019_290#Sec9
...
Policies can be time consuming to implement in terms of actually reviewing articles for publication. If there's a huge influx, it would be unreasonable to re-run every analysis submitted!
