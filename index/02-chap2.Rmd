...
Proactively, `fertile` catches when an absolute path, or one leading outside of the project directory, is referenced in an input or output function and prevents that path from being used, providing an informative warning message.
...
```{r path checks, error = TRUE, message = FALSE,eval = FALSE}
