...
`fertile` addresses code style via the function `has_no_lint()`. This function checks code for compatibility with the `tidyverse` "tidy" code format, which promotes the following best practices:
