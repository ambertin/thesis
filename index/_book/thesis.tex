...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.49K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  378.79K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpUIpMlQ/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpUIpMlQ/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpUIpMlQ/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpUIpMlQ/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
Reading from /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpUIpMlQ/project_miceps/.fertile_render_log.csv
\end{verbatim}
\begin{verbatim}
# A tibble: 1 x 4
  path          path_abs func        timestamp          
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2020-10-14 13:31:46
\end{verbatim}
...
6 project_mic~  187.49K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  378.79K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
\end{Shaded}
\begin{verbatim}
-- The available checks in `fertile` are as follows: ------------------------- fertile 0.0.0.9028 --
\end{verbatim}
\begin{verbatim}
...
\end{Shaded}
\begin{verbatim}
-- Analysis of reproducibility for project_miceps ---------------------------- fertile 0.0.0.9028 --
\end{verbatim}
\begin{verbatim}
...
# A tibble: 11 x 4
 ...
 3 proteins_v_time.p~ png      378.8K image/png                                 
...
\end{verbatim}
\begin{verbatim}
-- Summary of fertile checks ------------------------------------------------- fertile 0.0.0.9028 --
\end{verbatim}
\begin{verbatim}
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      623     2020-10-14 13:31:59
 2 package:dplyr           <NA>                      base::~ 2020-10-14 13:31:59
 3 package:readr           <NA>                      base::~ 2020-10-14 13:31:59
 4 package:tidyr           <NA>                      base::~ 2020-10-14 13:31:59
 5 package:ggplot2         <NA>                      base::~ 2020-10-14 13:31:59
 6 package:purrr           <NA>                      base::~ 2020-10-14 13:31:59
 7 Seed Before             <NA>                      623     2020-10-14 13:31:59
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2020-10-14 13:31:59
 9 Seed After              <NA>                      13      2020-10-14 13:31:59
10 Seed Before             <NA>                      13      2020-10-14 13:31:59
# ... with 11 more rows
\end{verbatim}
...
in some other coding languages.
...
\textbf{7) Be applicable to a wide variety of domains and users.}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process} \caption{A Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-42}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/gov-2001-replication} \caption{The Replication Assignment From Harvard Professor Gary King's Gov 2001 Graduate Course (Source: https://projects.iq.harvard.edu/files/gov2001/files/syllabus.pdf)}\label{fig:unnamed-chunk-43}
\end{figure}
