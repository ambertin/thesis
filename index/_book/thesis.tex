...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~   187.3K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  379.73K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmp9TxSC4/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-02-27 16:02:09
\end{verbatim}
...
6 project_mic~   187.3K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  379.73K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     187.62K image/png                                 
 3 proteins_v_time.p~ png     380.29K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      273     2021-02-27 16:02:58
 2 package:dplyr           <NA>                      base::~ 2021-02-27 16:02:58
 3 package:readr           <NA>                      base::~ 2021-02-27 16:02:58
 4 package:tidyr           <NA>                      base::~ 2021-02-27 16:02:58
 5 package:ggplot2         <NA>                      base::~ 2021-02-27 16:02:58
 6 package:purrr           <NA>                      base::~ 2021-02-27 16:02:58
 7 Seed Before             <NA>                      273     2021-02-27 16:02:58
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-02-27 16:02:58
 9 Seed After              <NA>                      287     2021-02-27 16:02:59
10 Seed Before             <NA>                      287     2021-02-27 16:02:59
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-71-1.pdf}
\caption{\label{fig:unnamed-chunk-71}Bar Chart: End of Course Reproducibility Test Averages by Group, Fall 2020}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-72-1.pdf}
\caption{\label{fig:unnamed-chunk-72}Scatterplot: Previous Coursework vs Total Reproducibility Test Score, Fall 2020}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-78}Boxplot: Pre- and Post-Test Score Distributions by Group, January Term 2021}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-79}Bar Chart: Pre- and Post-Test Score Differences For All Individuals, January Term 2021}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-80-1.pdf}
\caption{\label{fig:unnamed-chunk-80}Scatterplot: Previous Coursework Experience vs Reproducibility Score by Group, January Term 2021}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-84-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-84-2} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-84-3} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-84-4} \caption{RvF and QQ Plots for Fall 2020 (Top) January Term 2021 (Bottom) Simple Linear Regression Models}\label{fig:unnamed-chunk-84}
\end{figure}
