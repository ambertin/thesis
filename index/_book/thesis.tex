...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/6-components} \caption{The 6 Major Components of Reproducibility}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Reprodubility Policies of Top Statistical and Data Sciences Journals}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Popular Reproducibility Packages in R}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Popular Continuous Integration Tools}\label{fig:unnamed-chunk-7}
\end{figure}
...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  185.16K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  376.78K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmppN3RHm/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-03-10 16:07:40
\end{verbatim}
...
6 project_mic~  185.16K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  376.78K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/components-summary} \caption{Summary of Reproducibility Components and the Related Functionalities in 'fertile'}\label{fig:unnamed-chunk-42}
\end{figure}
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     187.69K image/png                                 
 3 proteins_v_time.p~ png     378.48K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      283     2021-03-10 16:08:21
 2 package:dplyr           <NA>                      base::~ 2021-03-10 16:08:21
 3 package:readr           <NA>                      base::~ 2021-03-10 16:08:21
 4 package:tidyr           <NA>                      base::~ 2021-03-10 16:08:21
 5 package:ggplot2         <NA>                      base::~ 2021-03-10 16:08:21
 6 package:purrr           <NA>                      base::~ 2021-03-10 16:08:21
 7 Seed Before             <NA>                      283     2021-03-10 16:08:21
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-03-10 16:08:21
 9 Seed After              <NA>                      300     2021-03-10 16:08:21
10 Seed Before             <NA>                      300     2021-03-10 16:08:21
# ... with 11 more rows
\end{verbatim}
\normalsize
