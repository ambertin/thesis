...
# A tibble: 12 x 5
 ...
 7 project_miceps/citr~  187.79K png   image/png                  citrate_v_tim~
 8 project_miceps/inst~      260 R     text/plain                 install_proj_~
 9 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
10 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
11 project_miceps/prot~   378.3K png   image/png                  proteins_v_ti~
12 project_miceps/soft~    5.34K txt   text/plain                 software-vers~
\end{verbatim}
\normalsize
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpZE0YtS/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-03-24 00:19:50
\end{verbatim}
...
project_miceps/citrate_v_time.png      project_miceps/install_proj_packages.R 
project_miceps/mice.csv                project_miceps/miceps.Rproj            
project_miceps/proteins_v_time.png     project_miceps/software-versions.txt   
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
# A tibble: 10 x 8
 ...
 1 project_mic~   14.43K csv   text/c~ Blot_data~ data-raw   project_mi~ file_m~
 2 project_mic~    7.39K csv   text/c~ CS_data_r~ data-raw   project_mi~ file_m~
 3 project_mic~   10.97K docx  applic~ Estrogen_~ inst/other project_mi~ file_m~
 4 project_mic~    5.21K Rmd   text/x~ analysis.~ vignettes  project_mi~ file_m~
 5 project_mic~    1.41M html  text/h~ analysis.~ inst/text  project_mi~ file_m~
 6 project_mic~  187.79K png   image/~ citrate_v~ inst/image project_mi~ file_m~
 7 project_mic~      260 R     text/p~ install_p~ R          project_mi~ file_m~
 8 project_mic~   14.33K csv   text/c~ mice.csv   data-raw   project_mi~ file_m~
 9 project_mic~   378.3K png   image/~ proteins_~ inst/image project_mi~ file_m~
10 project_mic~    5.34K txt   text/p~ software-~ inst/text  project_mi~ file_m~
\end{verbatim}
\normalsize
...
# A tibble: 2 x 2
  culprit                                expr 
  <fs::path>                             <chr>
1 project_miceps/analysis.Rmd            ""   
2 project_miceps/install_proj_packages.R ""   
\end{verbatim}
...
\end{Highlighting}
\end{Shaded}
However, there is no seed set in the file. As a result, \texttt{has\_no\_randomness()} returns as a failure for the project.
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Highlighting}
\end{Shaded}
In this situation, randomness occurs in the calling of \texttt{rnorm()}, but it is controlled by the use of \texttt{set.seed}. This time, \texttt{has\_no\_randomness()} passes without error:
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/components-summary} \caption{Summary of Reproducibility Components and the Related Functionalities in 'fertile'}\label{fig:unnamed-chunk-44}
\end{figure}
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     185.75K image/png                                 
 3 proteins_v_time.p~ png     375.48K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      586     2021-03-24 00:20:19
 2 package:dplyr           <NA>                      base::~ 2021-03-24 00:20:19
 3 package:readr           <NA>                      base::~ 2021-03-24 00:20:20
 4 package:tidyr           <NA>                      base::~ 2021-03-24 00:20:20
 5 package:ggplot2         <NA>                      base::~ 2021-03-24 00:20:20
 6 package:purrr           <NA>                      base::~ 2021-03-24 00:20:20
 7 Seed Before             <NA>                      586     2021-03-24 00:20:20
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-03-24 00:20:20
 9 Seed After              <NA>                      601     2021-03-24 00:20:21
10 Seed Before             <NA>                      601     2021-03-24 00:20:21
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process-2} \caption{Another Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-64}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-73-1.pdf}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-85-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-85-2} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-85-3} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-85-4} \caption{RvF and QQ Plots for Fall 2020 (Top) January Term 2021 (Bottom) Simple Linear Regression Models}\label{fig:unnamed-chunk-85}
\end{figure}
