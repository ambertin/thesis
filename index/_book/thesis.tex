...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.46K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  379.47K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpqy9p6h/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-03-25 17:26:05
\end{verbatim}
...
6 project_mic~  187.46K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  379.47K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/components-summary} \caption{Summary of Reproducibility Components and the Related Functionalities in 'fertile'}\label{fig:unnamed-chunk-46}
\end{figure}
...
# A tibble: 12 x 4
 ...
 3 proteins_v_time.p~ png      379.3K image/png                                 
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/shims-list} \caption{List of Functions Shimmed by 'fertile'}\label{fig:unnamed-chunk-54}
\end{figure}
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      590     2021-03-25 17:26:26
 2 package:dplyr           <NA>                      base::~ 2021-03-25 17:26:26
 3 package:readr           <NA>                      base::~ 2021-03-25 17:26:26
 4 package:tidyr           <NA>                      base::~ 2021-03-25 17:26:26
 5 package:ggplot2         <NA>                      base::~ 2021-03-25 17:26:26
 6 package:purrr           <NA>                      base::~ 2021-03-25 17:26:26
 7 Seed Before             <NA>                      590     2021-03-25 17:26:27
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-03-25 17:26:27
 9 Seed After              <NA>                      605     2021-03-25 17:26:27
10 Seed Before             <NA>                      605     2021-03-25 17:26:27
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process} \caption{Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-67}
\end{figure}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process-2} \caption{Another Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-68}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/gov-2001-replication} \caption{The Replication Assignment From Harvard Professor Gary King's Gov 2001 Graduate Course}\label{fig:unnamed-chunk-69}
\end{figure}
...
\end{itemize}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/tidytuesday} \caption{The Logo For Popular Tidy Tuesday Event}\label{fig:unnamed-chunk-70}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-76}Bar Chart: End of Course Reproducibility Test Averages by Group, Fall 2020}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-77}Scatterplot: Previous Coursework vs Total Reproducibility Test Score, Fall 2020}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-83}Boxplot: Pre- and Post-Test Score Distributions by Group, January Term 2021}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-84-1.pdf}
\caption{\label{fig:unnamed-chunk-84}Bar Chart: Pre- and Post-Test Score Differences For All Individuals, January Term 2021}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-85}Scatterplot: Previous Coursework Experience vs Reproducibility Score by Group, January Term 2021}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-89-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-89-2} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-89-3} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-89-4} \caption{RvF and QQ Plots for Fall 2020 (Top) January Term 2021 (Bottom) Simple Linear Regression Models}\label{fig:unnamed-chunk-89}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/a-b_testing} \caption{Scientific A/B Testing}\label{fig:unnamed-chunk-90}
\end{figure}
