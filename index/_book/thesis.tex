...
\subsection{Journal Statements On Reproducibility Across The
Sciences}\label{journal-statements-on-reproducibility-across-the-sciences}
...
\subsection{Journal Policies In The Statistical And Data
Sciences}\label{journal-policies-in-the-statistical-and-data-sciences}
...
As illustrated by the prior examples, academic publications across many
different disciplines have been making an effort to incorporate
reproducibility standards into their submission guidelines. The simple
...
So in practice, do academic reproducibility standards actually result in
...
\end{Shaded}
\begin{verbatim}
-- The available checks in `fertile` are as foll
\end{verbatim}
\begin{verbatim}
...
\end{Shaded}
\begin{verbatim}
-- Analysis of reproducibility for project_micep
\end{verbatim}
\begin{verbatim}
...
2      citrate_v_time.png   png 187.14K
3     proteins_v_time.png   png 378.86K
...
# A tibble: 6 x 4
  ...
  <chr>       <chr>                       <chr>    <dttm>             
1 package:re~ <NA>                        base::r~ 2020-09-07 16:54:51
2 package:th~ <NA>                        base::r~ 2020-09-07 16:54:51
3 package:th~ <NA>                        base::l~ 2020-09-07 16:54:51
4 package:pu~ <NA>                        base::l~ 2020-09-08 19:32:27
5 package:fo~ <NA>                        base::l~ 2020-09-08 19:32:27
6 project_mi~ /Users/audreybertin/Docume~ readr::~ 2020-09-08 19:32:27
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpV8ZnQG/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpV8ZnQG/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpV8ZnQG/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpV8ZnQG/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
