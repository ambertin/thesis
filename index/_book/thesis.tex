...
# A tibble: 11 x 5
 ...
 5 project_miceps/anal~    5.01K Rmd   text/x-markdown            analysis.Rmd  
 6 project_miceps/anal~    1.41M html  text/html                  analysis.html 
 7 project_miceps/citr~  186.82K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  377.58K png   image/png                  proteins_v_ti~
...
output function and prevents that path from being used, providing an
...
# A tibble: 11 x 4
 ...
 2 citrate_v_time.png png     188.53K image/png                                 
 3 proteins_v_time.p~ png     376.34K image/png                                 
...
11 analysis.Rmd       Rmd       5.01K text/x-markdown                           
\end{verbatim}
\begin{verbatim}
...
# A tibble: 7 x 4
  ...
  <chr>         <chr>                              <chr>     <dttm>             
1 package:remo~ <NA>                               base::re~ 2020-09-17 13:43:49
2 package:thes~ <NA>                               base::re~ 2020-09-17 13:43:49
3 package:thes~ <NA>                               base::li~ 2020-09-17 13:43:49
4 ~/Desktop/my~ ~/Desktop/my_data.csv              readr::r~ 2020-09-17 14:15:00
5 package:purrr <NA>                               base::li~ 2020-09-17 14:31:11
6 package:forc~ <NA>                               base::li~ 2020-09-17 14:31:11
7 project_mice~ /Users/audreybertin/Documents/the~ readr::r~ 2020-09-17 14:31:11
\end{verbatim}
\normalsize
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpgPHncJ/project_miceps/
