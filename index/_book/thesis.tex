...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~   188.7K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  380.26K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpCmvTSt/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-04-08 18:08:32
\end{verbatim}
...
6 project_mic~   188.7K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  380.26K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
# A tibble: 12 x 4
 ...
 3 proteins_v_time.p~ png     377.42K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      595     2021-04-08 18:09:02
 2 package:dplyr           <NA>                      base::~ 2021-04-08 18:09:02
 3 package:readr           <NA>                      base::~ 2021-04-08 18:09:02
 4 package:tidyr           <NA>                      base::~ 2021-04-08 18:09:03
 5 package:ggplot2         <NA>                      base::~ 2021-04-08 18:09:03
 6 package:purrr           <NA>                      base::~ 2021-04-08 18:09:03
 7 Seed Before             <NA>                      595     2021-04-08 18:09:03
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-04-08 18:09:03
 9 Seed After              <NA>                      609     2021-04-08 18:09:03
10 Seed Before             <NA>                      609     2021-04-08 18:09:03
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\caption{\label{tab:unnamed-chunk-79}End of Course Reproducibility Test Averages by Group, Fall 2020}
\centering
...
\caption{\label{tab:unnamed-chunk-88}Average Score Difference Between Beginning/End of Course, January Term 2021}
\centering
\begin{tabular}[t]{lrr}
\toprule
  & Control & Fertile\\
...
\caption{\label{fig:unnamed-chunk-89}Boxplot: Pre- and Post-Test Score Distributions by Group, January Term 2021}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-90}Scatterplot: Previous Coursework Experience vs Reproducibility Score by Group, January Term 2021}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-94-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-94-2} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-94-3} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-94-4} \caption{RvF and QQ Plots for Fall 2020 (Top) January Term 2021 (Bottom) Simple Linear Regression Models}\label{fig:unnamed-chunk-94}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/a-b_testing} \caption{Scientific A/B Testing}\label{fig:unnamed-chunk-95}
\end{figure}
...
Karpicke, J. D., \& Roediger, H. L. (2008). The critical importance of retrieval for learning. \emph{Science}, \emph{319}(5865), 966--968.
