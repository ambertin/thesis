...
\item
  ...
  (2017)).
\end{itemize}
\section{Current Attempts to Address Reproducibility in
Academia}\label{current-attempts-to-address-reproducibility-in-academia}

\subsection{Journal Requirements}\label{journal-requirements}
...
components defined previously is the \emph{American Journal of Political
Science} (AJPS). In 2012, the AJPS became the first political science
journal to require authors to make their data openly accessible online,
and the publication has instituted stricter requirements since. AJPS now
requires that authors submit the following alongside their papers:
\begin{itemize}
\tightlist
\item
...
These standards are quite thorough, meeting a variety of the conditions
...
A group of editors reproesenting over 30 major journals from the
biomedical sciences met in 2014 to address reproducibility in their
field, coming to a consensus on a set of principles they wanted to
uphold. Below are those relating specifically to the use of data and
statistical methods:
\begin{enumerate}
\def\labelenumi{\arabic{enumi})}
\item
  The journal should have a mechanism to check the statistical accuracy
  of submissions.
\item
...
\setcounter{enumi}{3}
\item
  All datasets must be made available on request and should be on public
  repositories when possible. If not possible, data values should be
  presented in the paper or supplementary information.
\item
...
(2016) previously. There is no requirement that code be shared, nor
metadata, and software requirements are somewhat loose.

\emph{Experimental Results}, a journal created by Cambridge University
Press for the specific purpose of addressing some of the reproducibility
and open access issues in academia, also fails to meet these
requirements. Allowing articles from a variety of disciplines, their
transparency and openness policy states only that ``whenever possible
authors should make evidence and resources that underpin published
findings, such as data, code, and other materials, available to readers
without undue barriers to access.'' It is only recommended, not
required, that code and data be fully available. The reproducibility
components that extend beyond what is required at a minimum are not
considered.
...
\url{https://www.researchgate.net/publication/288818031_Reproducible_research_in_statistics_A_review_and_guidelines_for_the_Biometrical_Journal}
...
2      citrate_v_time.png   png 187.99K
3     proteins_v_time.png   png 377.82K
...
# A tibble: 6 x 4
  ...
  <chr>       <chr>                       <chr>    <dttm>             
1 package:re~ <NA>                        base::r~ 2020-09-05 13:51:20
2 package:th~ <NA>                        base::r~ 2020-09-05 13:51:20
3 package:th~ <NA>                        base::l~ 2020-09-05 13:51:20
4 package:pu~ <NA>                        base::l~ 2020-09-05 15:08:02
5 package:fo~ <NA>                        base::l~ 2020-09-05 15:08:02
6 project_mi~ /Users/audreybertin/Docume~ readr::~ 2020-09-05 15:08:02
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmp1FN7qu/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmp1FN7qu/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmp1FN7qu/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmp1FN7qu/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
