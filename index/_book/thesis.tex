...
# A tibble: 11 x 5
 ...
 5 project_miceps/anal~    5.05K Rmd   text/x-markdown            analysis.Rmd  
 6 project_miceps/anal~    1.41M html  text/html                  analysis.html 
 7 project_miceps/citr~   188.3K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  377.39K png   image/png                  proteins_v_ti~
...
should be reorganized, if at all. These suggestions are based on
achieving the optimal file structure design for reproducibility, argued
by Marwick et al. (2018) to be that of an \texttt{R} package
(R-Core-Team (2020), Wickham (2015)), with an \texttt{R} folder, as well
as \texttt{data}, \texttt{data-raw}, \texttt{inst}, and
\texttt{vignettes}. Such a structure keeps all of the files separated
and in clearly labeled directories where they are easy to find.
Additionally, the extension of the \texttt{R} package structure to data
analysis projects promotes standardization of file structure within the
R community. \texttt{proj\_move\_files()} executes these suggestions,
building a package structure and sorting files into the correct folders
by type.
...
\end{itemize}
Once an \texttt{R} Project is created, \texttt{fertile} provides
...
# A tibble: 11 x 4
 ...
 2 citrate_v_time.png png     187.83K image/png                                 
 3 proteins_v_time.p~ png     379.64K image/png                                 
...
11 analysis.Rmd       Rmd       5.05K text/x-markdown                           
\end{verbatim}
\begin{verbatim}
...
# A tibble: 9 x 4
  ...
  <chr>            <chr>                            <chr>    <dttm>             
1 package:remotes  <NA>                             base::r~ 2020-09-17 17:34:03
2 package:thesisd~ <NA>                             base::r~ 2020-09-17 17:34:03
3 package:thesisd~ <NA>                             base::l~ 2020-09-17 17:34:03
4 package:dplyr    <NA>                             base::l~ 2020-09-17 17:35:14
5 package:tidyr    <NA>                             base::l~ 2020-09-17 17:35:15
6 project_miceps/~ /Users/audreybertin/Documents/t~ readr::~ 2020-09-17 17:35:15
7 package:purrr    <NA>                             base::l~ 2020-09-17 17:35:27
8 package:forcats  <NA>                             base::l~ 2020-09-17 17:35:27
9 project_miceps/~ /Users/audreybertin/Documents/t~ readr::~ 2020-09-17 17:35:27
\end{verbatim}
\normalsize
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpONPdG4/project_miceps/
