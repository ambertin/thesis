...
\section{Challenges for Journals}\label{challenges-for-journals}
...
Most journals have been reluctant to give additional tasks to peer
reviewers who may already be overburdened with the continually
increasing volume of submissions.

\url{https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0166387}

As a result, policies often encourage reviewers to consider authors'
compliance with data sharing policies, but formal peer review of data
only occurs in a small number of journals.
...
2      citrate_v_time.png   png 185.13K
3     proteins_v_time.png   png 378.24K
...
# A tibble: 6 x 4
  ...
  <chr>       <chr>                       <chr>    <dttm>             
1 package:re~ <NA>                        base::r~ 2020-09-10 13:54:29
2 package:th~ <NA>                        base::r~ 2020-09-10 13:54:29
3 package:th~ <NA>                        base::l~ 2020-09-10 13:54:29
4 package:pu~ <NA>                        base::l~ 2020-09-10 13:55:24
5 package:fo~ <NA>                        base::l~ 2020-09-10 13:55:24
6 project_mi~ /Users/audreybertin/Docume~ readr::~ 2020-09-10 13:55:24
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpPyxvOG/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpPyxvOG/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpPyxvOG/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpPyxvOG/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
