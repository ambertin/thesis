...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmprlc45x/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmprlc45x/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmprlc45x/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmprlc45x/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
Reading from /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmprlc45x/project_miceps/.fertile_render_log.csv
\end{verbatim}
\begin{verbatim}
# A tibble: 1 x 4
  path          path_abs func        timestamp          
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-02-19 21:57:20
\end{verbatim}
...
# A tibble: 11 x 4
 ...
 2 citrate_v_time.png png     188.04K image/png                                 
 3 proteins_v_time.p~ png     378.25K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      599     2021-02-19 21:57:39
 2 package:dplyr           <NA>                      base::~ 2021-02-19 21:57:39
 3 package:readr           <NA>                      base::~ 2021-02-19 21:57:39
 4 package:tidyr           <NA>                      base::~ 2021-02-19 21:57:39
 5 package:ggplot2         <NA>                      base::~ 2021-02-19 21:57:39
 6 package:purrr           <NA>                      base::~ 2021-02-19 21:57:39
 7 Seed Before             <NA>                      599     2021-02-19 21:57:39
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-02-19 21:57:40
 9 Seed After              <NA>                      613     2021-02-19 21:57:40
10 Seed Before             <NA>                      613     2021-02-19 21:57:40
# ... with 11 more rows
\end{verbatim}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process} \caption{Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-42}
\end{figure}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process-2} \caption{Another Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-43}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/gov-2001-replication} \caption{The Replication Assignment From Harvard Professor Gary King's Gov 2001 Graduate Course}\label{fig:unnamed-chunk-44}
\end{figure}
...
\end{enumerate}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/projects-1} \caption{Sample Question From The Section On RStudio Projects}\label{fig:unnamed-chunk-47}
\end{figure}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/projects-2} \caption{Another Sample Question From The Section On RStudio Projects}\label{fig:unnamed-chunk-48}
\end{figure}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
...
\end{enumerate}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/paths-1} \caption{Sample Question From The Section On File Paths}\label{fig:unnamed-chunk-49}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(fall2020, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Previous_Classes, }\DataTypeTok{y =}\NormalTok{ Overall_Total, }\DataTypeTok{col =}\NormalTok{ Group)) }\OperatorTok{+}\StringTok{ }
...
\includegraphics{thesis_files/figure-latex/unnamed-chunk-59-1.pdf}
...
\includegraphics{thesis_files/figure-latex/unnamed-chunk-65-1.pdf} \includegraphics{thesis_files/figure-latex/unnamed-chunk-65-2.pdf}

\includegraphics{thesis_files/figure-latex/unnamed-chunk-66-1.pdf} \includegraphics{thesis_files/figure-latex/unnamed-chunk-66-2.pdf}
...
Although the conclusions from this experiment are not particularly exciting, the implications of the study extend far beyond just this software.

\ldots{} {[}\textbf{Go into idea of software A/B testing}{]}
