...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.53K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  376.45K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpQGzPsp/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-02-22 21:43:03
\end{verbatim}
...
6 project_mic~  187.53K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  376.45K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/components-summary} \caption{Summary of Reproducibility Components and the Related Functionalities in 'fertile'}\label{fig:unnamed-chunk-41}
\end{figure}
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     183.02K image/png                                 
 3 proteins_v_time.p~ png     376.97K image/png                                 
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/shims-list} \caption{List of Functions Shimmed by 'fertile'}\label{fig:unnamed-chunk-51}
\end{figure}
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      254     2021-02-22 21:43:36
 2 package:dplyr           <NA>                      base::~ 2021-02-22 21:43:36
 3 package:readr           <NA>                      base::~ 2021-02-22 21:43:36
 4 package:tidyr           <NA>                      base::~ 2021-02-22 21:43:36
 5 package:ggplot2         <NA>                      base::~ 2021-02-22 21:43:36
 6 package:purrr           <NA>                      base::~ 2021-02-22 21:43:36
 7 Seed Before             <NA>                      254     2021-02-22 21:43:36
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-02-22 21:43:36
 9 Seed After              <NA>                      268     2021-02-22 21:43:37
10 Seed Before             <NA>                      268     2021-02-22 21:43:37
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process} \caption{Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-62}
\end{figure}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process-2} \caption{Another Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-63}
\end{figure}
...
\end{itemize}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/gov-2001-replication} \caption{The Replication Assignment From Harvard Professor Gary King's Gov 2001 Graduate Course}\label{fig:unnamed-chunk-64}
\end{figure}
...
\end{itemize}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/tidytuesday} \caption{The Logo For Popular Tidy Tuesday Event}\label{fig:unnamed-chunk-65}
\end{figure}
...
\end{enumerate}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/projects-1} \caption{Sample Question From Experimental Section On RStudio Projects}\label{fig:unnamed-chunk-67}
\end{figure}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/projects-2} \caption{Another Sample Question From Experimental Section On RStudio Projects}\label{fig:unnamed-chunk-68}
\end{figure}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
...
\end{enumerate}
\begin{figure}
\includegraphics[width=1\linewidth]{figure/paths-1} \caption{Sample Question From Experimental Section On File Paths}\label{fig:unnamed-chunk-69}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-74-1.pdf}
\caption{\label{fig:unnamed-chunk-74}Bar Chart: End of Course Reproducibility Test Averages by Group, Fall 2020}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-75}Scatterplot: Previous Coursework vs Total Reproducibility Test Score, Fall 2020}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-81}Boxplot: Pre- and Post-Test Score Distributions by Group, January Term 2021}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-82}Bar Chart: Pre- and Post-Test Score Differences For All Individuals, January Term 2021}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-83-1.pdf}
\caption{\label{fig:unnamed-chunk-83}Scatterplot: Previous Coursework Experience vs Reproducibility Score by Group, January Term 2021}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-87-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-87-2} \caption{RvF and QQ Plots for Fall 2020 Simple Linear Regression Model}\label{fig:unnamed-chunk-87}
\end{figure}
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-88-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-88-2} \caption{RvF and QQ Plots for January Term 2021 Simple Linear Regression Model}\label{fig:unnamed-chunk-88}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/a-b_testing} \caption{Scientific A/B Testing}\label{fig:unnamed-chunk-89}
\end{figure}
...
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
        \FunctionTok{stop}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"You need to run install.packages(}\SpecialCharTok{\textbackslash{}"}\StringTok{remotes}\SpecialCharTok{\textbackslash{}"}\StringTok{)}\SpecialCharTok{\textbackslash{}"}\StringTok{,}
\StringTok{            }\SpecialCharTok{\textbackslash{}"}\StringTok{first in the Console."}\NormalTok{))}
\NormalTok{    \}}
\NormalTok{\}}
...
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
        \FunctionTok{stop}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"You need to run"}\NormalTok{, }\StringTok{"remotes::install\_github(}\SpecialCharTok{\textbackslash{}"}\StringTok{ismayc/thesisdown}\SpecialCharTok{\textbackslash{}"}\StringTok{)"}\NormalTok{, }
