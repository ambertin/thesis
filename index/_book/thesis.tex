...
\end{Shaded}
\begin{verbatim}
Reading from /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpvd91Hs/project_miceps/.fertile_render_log.csv
\end{verbatim}
\begin{verbatim}
# A tibble: 1 x 4
  path          path_abs func        timestamp          
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2020-09-27 21:56:30
\end{verbatim}
\normalsize
...
# A tibble: 15 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      238     2020-09-27 21:56:32
 2 package:dplyr           <NA>                      base::~ 2020-09-27 21:56:32
 3 package:readr           <NA>                      base::~ 2020-09-27 21:56:32
 4 package:tidyr           <NA>                      base::~ 2020-09-27 21:56:32
 5 package:ggplot2         <NA>                      base::~ 2020-09-27 21:56:32
 6 package:purrr           <NA>                      base::~ 2020-09-27 21:56:32
 7 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2020-09-27 21:56:32
 8 Blot_data_updated.csv   /Users/audreybertin/Docu~ readr:~ 2020-09-27 21:56:32
 9 proteins_v_time.png     /Users/audreybertin/Docu~ ggplot~ 2020-09-27 21:56:33
10 CS_data_redone.csv      /Users/audreybertin/Docu~ readr:~ 2020-09-27 21:56:34
11 citrate_v_time.png      /Users/audreybertin/Docu~ ggplot~ 2020-09-27 21:56:35
12 package:skimr           <NA>                      base::~ 2020-09-27 21:56:36
13 package:stargazer       <NA>                      base::~ 2020-09-27 21:56:37
14 Seed @ End              <NA>                      484     2020-09-27 21:56:39
15 LAST RENDERED           <NA>                      proj_r~ 2020-09-27 21:56:39
\end{verbatim}
...
\texttt{fertile} could change this, allowing for many more colleges and
universities to integrate reproducibility into their courses.

In order for \texttt{fertile} to successfully be integrated into a
college course, the participating students must have the following:
\begin{itemize}
\tightlist
\item
  R and RStudio installed on their computer
\item
  Knowledge of how to install a package from GitHub and load it
\item
  Knowledge of how to create an R project
\item
  Knowledge of how to run basic functions and input simple file paths
\end{itemize}
These are relatively basic skills that can be taught to students within
the first week or two of their introduction to \texttt{R}.
