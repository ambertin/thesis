...
\texttt{fertile}, and the authors of all of the R packages utilized by
\texttt{fertile} to achieve its functionality.
}
...
This project would not have been possible without the help of Prof.~Ben
Baumer. Ben has been interested in scientific reproducibility for a
number of years and has done great work in the field. Some of this work
has been theoretical, but much has also been practical. Ben is one of
the pioneers in the practice of teaching reproducibility at the
undergraduate level, and his work in this area has received a lot of
positive feedback.

I would not be here writing this thesis without him. The Introduction to
Data Science course I took with him in my first semester at Smith
College spurred on my love for the field, prompting me to declare a
major---with Ben as my advisor---soon after. That course was my first
introduction to reproducibility. In it, I learned about how to create
narrative reports with RMarkdown, how to implement version control on
GitHub, how to write well-styled code, and how to use R projects to
structure my files in a way that was easy to manage. Through this work,
I began to see the benefits of a reproducible workflow. When I worked on
projects with other students, these tools enabled us to collaborate with
one another easily, and when I tried to look back at my own work from
the past, my attention to reproducibility meant that it was much easier
for me to re-compute and understand what I had done previously.

The love for R and data science that I developed in Ben's course
prompted me to pursue research in the field. As soon as I felt that I
had built up enough coding experience to be able to tackle challenging
issues, I reached out to the data science faculty for an opportunity.
Ben enthusiastically welcomed me in, telling me that he had recently
started developing an R package focused on reproducibility and offering
me a position assisting him with writing it. That package was
\texttt{fertile}.
...
familiarize myself with the process of writing R packages.
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpxzK47i/project_miceps
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpxzK47i/project_miceps/Blot_data_updated.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpxzK47i/project_miceps/CS_data_redone.csv
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpxzK47i/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
...
\end{Shaded}
\begin{verbatim}
Reading from /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpxzK47i/project_miceps/.fertile_render_log.csv
\end{verbatim}
\begin{verbatim}
# A tibble: 1 x 4
  path          path_abs func        timestamp          
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2020-10-09 16:25:49
\end{verbatim}
What we \emph{need}:
\begin{itemize}
\tightlist
...
\end{Shaded}
\begin{verbatim}
Error: Detected paths that lead outside the project directory. Such paths are not reproducible and will likely only work on your computer. If you would like to continue anyway, re-execute your command by typing the name of the package it originates from followed by :: and the function call, e.g. if you previously typed 'read_csv(path)', instead use 'readr::read_csv(path)'
\end{verbatim}
...
# A tibble: 11 x 4
 ...
 2 citrate_v_time.png png     187.28K image/png                                 
 3 proteins_v_time.p~ png     378.27K image/png                                 
...
# A tibble: 15 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      480     2020-10-09 16:26:04
 2 package:dplyr           <NA>                      base::~ 2020-10-09 16:26:04
 3 package:readr           <NA>                      base::~ 2020-10-09 16:26:04
 4 package:tidyr           <NA>                      base::~ 2020-10-09 16:26:04
 5 package:ggplot2         <NA>                      base::~ 2020-10-09 16:26:04
 6 package:purrr           <NA>                      base::~ 2020-10-09 16:26:04
 7 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2020-10-09 16:26:04
 8 Blot_data_updated.csv   /Users/audreybertin/Docu~ readr:~ 2020-10-09 16:26:04
 9 proteins_v_time.png     /Users/audreybertin/Docu~ ggplot~ 2020-10-09 16:26:05
10 CS_data_redone.csv      /Users/audreybertin/Docu~ readr:~ 2020-10-09 16:26:07
11 citrate_v_time.png      /Users/audreybertin/Docu~ ggplot~ 2020-10-09 16:26:07
12 package:skimr           <NA>                      base::~ 2020-10-09 16:26:08
13 package:stargazer       <NA>                      base::~ 2020-10-09 16:26:10
14 Seed @ End              <NA>                      105     2020-10-09 16:26:11
15 LAST RENDERED           <NA>                      proj_r~ 2020-10-09 16:26:11
\end{verbatim}
