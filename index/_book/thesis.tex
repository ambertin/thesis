...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.13K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  378.42K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpusY360/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-04-03 12:41:27
\end{verbatim}
...
6 project_mic~  187.13K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  378.42K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     185.19K image/png                                 
 3 proteins_v_time.p~ png     378.11K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      598     2021-04-03 12:41:48
 2 package:dplyr           <NA>                      base::~ 2021-04-03 12:41:48
 3 package:readr           <NA>                      base::~ 2021-04-03 12:41:48
 4 package:tidyr           <NA>                      base::~ 2021-04-03 12:41:49
 5 package:ggplot2         <NA>                      base::~ 2021-04-03 12:41:49
 6 package:purrr           <NA>                      base::~ 2021-04-03 12:41:49
 7 Seed Before             <NA>                      598     2021-04-03 12:41:49
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-04-03 12:41:49
 9 Seed After              <NA>                      612     2021-04-03 12:41:49
10 Seed Before             <NA>                      612     2021-04-03 12:41:49
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/journal-process-2} \caption{Another Potential 'fertile' Journal Review Process}\label{fig:unnamed-chunk-72}
\end{figure}
...
\texttt{fertile} can also provide benefits in other domains. Though not an exhaustive list, some of the potential uses of the software are:
\begin{itemize}
\item
...
\end{enumerate}
The \texttt{sds192} package operates by leveraging an \texttt{.onAttach()} function to scan the \texttt{R} environment of each student \emph{each time the package is loaded}, collect their unique identifier--again, via \texttt{whoami::username()}-- and run it through the same hashing algorithm as before. \texttt{sds192} came pre-coded with the hashed identifiers of all of the students, grouped by whether they had been assigned to the experimental or the control group, to facilitate the operation of \texttt{.onAttach()}.
...
\setcounter{enumi}{4}
\item
  Everyone received the same \texttt{sds192} package, which consisted of some data sets and \texttt{R} Markdown templates necessary for completing homework assignments and projects in the class. However, it functioned differently depending on each student's experimental group. The \texttt{control} group did not have \texttt{fertile} loaded, but the \texttt{experimental} group did. When \texttt{experimental} group users loaded \texttt{sds192}, the package silently loaded \texttt{fertile} as well. This meant that \texttt{fertile}'s proactive features were enabled, and therefore users would receive warning messages when they used absolute or non-portable paths or attempted to change their working directory. T
\item
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-88-1.pdf}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/unnamed-chunk-89-1.pdf}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-93-1} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-93-2} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-93-3} \includegraphics[width=0.5\linewidth]{thesis_files/figure-latex/unnamed-chunk-93-4} \caption{RvF and QQ Plots for Fall 2020 (Top) January Term 2021 (Bottom) Simple Linear Regression Models}\label{fig:unnamed-chunk-93}
\end{figure}
