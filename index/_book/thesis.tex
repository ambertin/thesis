...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.98K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  378.31K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpoJdoUu/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-05-18 00:13:16
\end{verbatim}
...
6 project_mic~  187.98K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  378.31K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     187.77K image/png                                 
 3 proteins_v_time.p~ png      375.8K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      582     2021-05-18 00:13:39
 2 package:dplyr           <NA>                      base::~ 2021-05-18 00:13:39
 3 package:readr           <NA>                      base::~ 2021-05-18 00:13:39
 4 package:tidyr           <NA>                      base::~ 2021-05-18 00:13:40
 5 package:ggplot2         <NA>                      base::~ 2021-05-18 00:13:40
 6 package:purrr           <NA>                      base::~ 2021-05-18 00:13:40
 7 Seed Before             <NA>                      582     2021-05-18 00:13:40
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-05-18 00:13:40
 9 Seed After              <NA>                      596     2021-05-18 00:13:40
10 Seed Before             <NA>                      596     2021-05-18 00:13:40
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\hypertarget{other-specific-areas}{%
\subsection{Other Specific Areas}\label{other-specific-areas}}
...
\end{figure}
\hypertarget{general-r-users}{%
\subsection{General R Users}\label{general-r-users}}

\texttt{fertile} is not only helpful in the specific circumstances described in the previous few sections. It can also provide benefits to \texttt{R} users more generally. All users, no matter their end goal, can see positive changes by focusing more on the reproducibility of their work.

\texttt{fertile} promotes the use of an R project format, which can help simplify the process of referencing and sharing files. It also encourages users to use an R package structure, which can make it easier to share functions and data that come alongside projects.
