...
10 project_miceps/prot~   379.3K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpTjgweg/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-03-29 13:50:42
\end{verbatim}
...
8 project_mic~   379.3K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     187.16K image/png                                 
 3 proteins_v_time.p~ png     380.23K image/png                                 
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      598     2021-03-29 13:51:30
 2 package:dplyr           <NA>                      base::~ 2021-03-29 13:51:30
 3 package:readr           <NA>                      base::~ 2021-03-29 13:51:30
 4 package:tidyr           <NA>                      base::~ 2021-03-29 13:51:30
 5 package:ggplot2         <NA>                      base::~ 2021-03-29 13:51:30
 6 package:purrr           <NA>                      base::~ 2021-03-29 13:51:31
 7 Seed Before             <NA>                      598     2021-03-29 13:51:31
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-03-29 13:51:31
 9 Seed After              <NA>                      612     2021-03-29 13:51:31
10 Seed Before             <NA>                      612     2021-03-29 13:51:31
# ... with 11 more rows
\end{verbatim}
\normalsize
...
\texttt{read\_csv()} is not alone. Many functions like it have a large number of arguments. It would be a very cumbersome process to have to re-write all of them arguments by hand in each shim. Additionally, it would make the shim-writing process not very reproducible: if every shim took a lengthy list of arguments with all different names and types, which all had to be specified in the definition of each shim, it would be incredibly complicated to scale up the library of available shims! There would be no easy method to automate this process, so many would have to be written by hand.
