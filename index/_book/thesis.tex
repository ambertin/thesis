...
# A tibble: 11 x 5
 ...
 7 project_miceps/citr~  187.58K png   image/png                  citrate_v_tim~
 8 project_miceps/mice~   14.33K csv   text/csv                   mice.csv      
 9 project_miceps/mice~      204 Rproj text/rstudio               miceps.Rproj  
10 project_miceps/prot~  375.28K png   image/png                  proteins_v_ti~
...
\end{Shaded}
\begin{verbatim}
/var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpoolAEU/project_miceps/
...
# A tibble: 1 x 4
  ...
  <chr>         <chr>    <chr>       <dttm>             
1 LAST RENDERED <NA>     proj_render 2021-02-22 15:18:08
\end{verbatim}
...
6 project_mic~  187.58K png   image/p~ citrate_v~ inst/image project_mi~ file_m~
7 project_mic~   14.33K csv   text/csv mice.csv   data-raw   project_mi~ file_m~
8 project_mic~  375.28K png   image/p~ proteins_~ inst/image project_mi~ file_m~
...
\NormalTok{    time }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ }\DecValTok{-1}\NormalTok{,}
...
\NormalTok{    time }\OperatorTok{==}\StringTok{ }\DecValTok{5} \OperatorTok{~}\StringTok{ }\DecValTok{7}\NormalTok{),}
...
\NormalTok{mice_tidy <-}\StringTok{ }\NormalTok{mice }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{time) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =} \StringTok{"protein"}\NormalTok{, }\DataTypeTok{value =} \StringTok{"amount"}\NormalTok{, }\OperatorTok{-}\NormalTok{day, }\OperatorTok{-}\NormalTok{sex, }\OperatorTok{-}\NormalTok{id, }\OperatorTok{-}\NormalTok{type) }\OperatorTok{%>%}\StringTok{ }
...
# A tibble: 12 x 4
 ...
 2 citrate_v_time.png png     188.42K image/png                                 
...
\KeywordTok{add_shim}\NormalTok{(}\DataTypeTok{func =} \StringTok{"write.ftable"}\NormalTok{, }\DataTypeTok{package =} \StringTok{"stats"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
...
\KeywordTok{find_all_shimmable_functions}\NormalTok{()}

\CommentTok{# Return list of all potential shims from a SPECIFIC package (e.g dplyr)}
\KeywordTok{find_pkg_shimmable_functions}\NormalTok{(}\DataTypeTok{package =} \StringTok{"dplyr"}\NormalTok{)}

\CommentTok{# Write/load all of the shims from find_all_shimmable_functions()}
\KeywordTok{add_all_possible_shims}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
...
# A tibble: 21 x 4
   path                    path_abs                  func    timestamp          
   <chr>                   <chr>                     <chr>   <dttm>             
 1 Seed @ Start            <NA>                      271     2021-02-22 15:18:55
 2 package:dplyr           <NA>                      base::~ 2021-02-22 15:18:55
 3 package:readr           <NA>                      base::~ 2021-02-22 15:18:55
 4 package:tidyr           <NA>                      base::~ 2021-02-22 15:18:56
 5 package:ggplot2         <NA>                      base::~ 2021-02-22 15:18:56
 6 package:purrr           <NA>                      base::~ 2021-02-22 15:18:56
 7 Seed Before             <NA>                      271     2021-02-22 15:18:56
 8 /Users/audreybertin/Do~ /Users/audreybertin/Docu~ readr:~ 2021-02-22 15:18:56
 9 Seed After              <NA>                      285     2021-02-22 15:18:56
10 Seed Before             <NA>                      285     2021-02-22 15:18:56
# ... with 11 more rows
\end{verbatim}
\normalsize
