...
- `proj_check_badge()`: run subset of checks for specific badge
...
- Getting some traction among top names (including RStudio/tidyverse team)
- Hoping one day for journals and educators to pick it up!
...
ggplot(jterm_model_data, aes(x = reorder(Student_ID, Score_Difference), y = Score_Difference, fill = Group)) + 
  ...
  xlab(NULL) +
  scale_fill_brewer(palette = "Paired") +
  ggtitle("Score Changes Across Course for All Students, J-Term 2021")
```
---
## Additional Info: Experiment (Jan 2021)
...
ggplot(jterm2021, aes(x = Previous_Classes, y = Overall_Total, color = Test)) + 
  ...
  facet_wrap(~Group) +
  scale_color_brewer(palette = "Paired") + 
  ggtitle("Previous Classes vs Pre/Post Test Scores, J-Term 2021")
```
